...
! function(e) {
	...
	n.prototype.cache = o, n.prototype.define = function(e, t) {
		...
		var f = e[0],
			m = 0;
		if (l = l || [], o.host = o.host || (y.match(/\/\/([\s\S]+?)\//) || ["//" + location.host + "/"])[0], 0 === e.length ||
			layui["layui.all"] && u[f] || !layui["layui.all"] && layui["layui.mobile"] && u[f]) return c(), p;
		...
		return u.rel = "stylesheet", u.href = e + (o.debug ? "?v=" + (new Date).getTime() : ""), u.media = "all", t.getElementById(
			c) || l.appendChild(u), "function" != typeof n ? a : (function y() {
			return ++p > 1e3 * o.timeout / 100 ? i(e + " timeout") : void(1989 === parseInt(a.getStyle(t.getElementById(c),
				"width")) ? function() {
				n()
			}() : setTimeout(y, 100))
		}(), a)
		...
		if (t = t || "layui", e.JSON && e.JSON.parse) {
			...
			return "value" in o && (n[o.key] = o.value), o.remove && delete n[o.key], localStorage[t] = JSON.stringify(n), o.key ?
				n[o.key] : n
		}
...
layui.define("jquery", function(i) {
	...
	s.prototype.set = function(i) {
		...
		return s[0] ? s.before(c) : n.append(c), o.append('<div class="layui-tab-item">' + (a.content || "") + "</div>"),
			y.hideTabMore(!0), y.tabAuto(), this
		...
		y = {
			tabClick: function(i, a, s, o) {
				...
				"javascript:;" !== d.attr("href") && "_blank" === d.attr("target") || (c.addClass(l).siblings().removeClass(l),
					u.eq(a).addClass(n).siblings().removeClass(n)), layui.event.call(this, e, "tab(" + h + ")", {
					elem: r,
					index: a
				})
			},
			tabDelete: function(i, a) {
				var n = a || t(this).parent(),
					...
					r = o.attr("lay-filter");
				n.hasClass(l) && (n.next()[0] ? y.tabClick.call(n.next()[0], null, s + 1) : n.prev()[0] && y.tabClick.call(n.prev()[
					0], null, s - 1)), n.remove(), c.eq(s).remove(), setTimeout(function() {
					y.tabAuto()
			...
			clickThis: function() {
				...
				i.find("." + d)[0] || ("javascript:;" !== s.attr("href") && "_blank" === s.attr("target") || c || (a.find("." +
					l).removeClass(l), i.addClass(l)), layui.event.call(this, e, "nav(" + n + ")", i))
			},
			clickChild: function() {
				var i = t(this),
					a = i.parents(o),
			...
			collapse: function() {
				...
				l[c ? "addClass" : "removeClass"](n), a.html(c ? "&#xe61a;" : "&#xe602;"), layui.event.call(this, e, "collapse(" +
					o + ")", {
						title: i,
						content: l,
						show: c
					...
					var i = 200,
						...
						v = function(l, o, c) {
							...
							o.hasClass(u) ? l.css({
								...
								}, a.ie && a.ie < 10 ? 0 : i), clearTimeout(p[c]), "block" === y.css("display") && clearTimeout(s[c]), s[c] =
								setTimeout(function() {
					...
					t("." + i + l).each(function() {
						...
						i.each(function() {
							...
							a.find(".layui-colla-icon").remove(), a.append('<i class="layui-icon layui-colla-icon">' + (l ?
								"&#xe602;" : "&#xe61a;") + "</i>"), a.off("click", y.collapse).on("click", y.collapse)
						})
					})
				}
			};
...
layui.define("layer", function(e) {
	...
	p.prototype.config = {
		...
		var e = this,
			i = e.config,
			n = e.elemFile = t(['<input class="' + u + '" type="file" name="' + i.field + '"', i.multiple ? " multiple" : "",
				">"
			].join("")),
			o = i.elem.next();
		...
		var e = this,
			...
			a = t(['<form target="' + f + '" class="' + c + '" method="' + i.method,
				'" key="set-mine" enctype="multipart/form-data" action="' + i.url + '">', "</form>"
			].join(""));
		t("#" + f)[0] || t("body").append(n), i.elem.next().hasClass(f) || (e.elemFile.wrap(a), i.elem.next("." + f).append(
			function() {
				var e = [];
			...
			d = {
				select: function() {
							...
							if (!c) {
								...
								f && m.on("keyup", w).on("blur", function(i) {
									...
									var e = i(this),
										a = e.attr("lay-value"),
										n = h.attr("lay-filter");
									return !e.hasClass(o) && (e.hasClass("layui-select-tips") ? m.val("") : (m.val(e.text()), e.addClass(r)),
										e.siblings().removeClass(r), h.val(a).removeClass("layui-form-danger"), layui.event.call(this, l,
											"select(" + n + ")", {
												elem: h[0],
												value: a,
												othis: t
					...
					f.each(function(e, l) {
						...
						var v = "string" == typeof s.attr("lay-search"),
							...
							m = i(['<div class="' + (v ? "" : "layui-unselect ") + a + (c ? " layui-select-disabled" : "") + '">',
								'<div class="' + n + '"><input type="text" placeholder="' + p + '" value="' + (d ? f.html() : "") + '" ' +
								(v ? "" : "readonly") + ' class="layui-input' + (v ? "" : " layui-unselect") + (c ? " " + o : "") + '">',
								'<i class="layui-edge"></i></div>', '<dl class="layui-anim layui-anim-upbit' + (s.find("optgroup")[0] ?
									" layui-select-group" : "") + '">' + function(e) {
									var i = [];
									return layui.each(e, function(e, a) {
										0 !== e || a.value ? "optgroup" === a.tagName.toLowerCase() ? i.push("<dt>" + a.label + "</dt>") : i
											.push('<dd lay-value="' + a.value + '" class="' + (d === a.value ? r : "") + (a.disabled ? " " + o :
				...
				checkbox: function() {
					...
					t.each(function(t, n) {
						...
						var d = l.next("." + c[0]),
							f = i(['<div class="layui-unselect ' + c[0] + (n.checked ? " " + c[1] : "") + (u ?
									" layui-checkbox-disbaled " + o : "") + '" lay-skin="' + (s || "") + '">', {
									_switch: "<em>" + ((n.checked ? r[0] : r[1]) || "") + "</em><i></i>"
								} [s] || (n.title.replace(/\s/g, "") ? "<span>" + n.title + "</span>" : "") + '<i class="layui-icon">' +
								(s ? "&#xe605;" : "&#xe618;") + "</i>", "</div>"
							].join(""));
				...
				radio: function() {
					var e = "layui-form-radio",
						...
						n = function(a) {
							...
							a.on("click", function() {
								...
								}), n[0].checked = !0, a.addClass(e + "ed"), a.find(".layui-icon").addClass(r).html(t[0]), layui.event.call(
									n[0], l, "radio(" + c + ")", {
										elem: n[0],
										value: n[0].value,
										othis: a
					...
					a.each(function(a, l) {
						var s = i(this),
							...
							u = this.disabled;
						if ("string" == typeof s.attr("lay-ignore")) return s.show();
						var c = i(['<div class="layui-unselect ' + e + (l.checked ? " " + e + "ed" : "") + (u ?
								" layui-radio-disbaled " + o : "") + '">', '<i class="layui-anim layui-icon">' + t[l.checked ? 0 : 1] +
...
layui.define(["laytpl", "laypage", "layer", "form"], function(e) {
	...
	var t = layui.$,
		...
		T = [
			...
			"{{# var left, right; }}", '<div class="layui-table-header">', W(), "</div>",
			'<div class="layui-table-body layui-table-main">', z, "</div>", "{{# if(left){ }}",
			'<div class="layui-table-fixed layui-table-fixed-l">', '<div class="layui-table-header">', W({
				fixed: !0
			}), "</div>", '<div class="layui-table-body">', z, "</div>", "</div>", "{{# }; }}", "{{# if(right){ }}",
			'<div class="layui-table-fixed layui-table-fixed-r">', '<div class="layui-table-header">', W({
				fixed: "right"
	...
	A.prototype.config = {
		...
		}), t.height && /^full-\d+$/.test(t.height) && (e.fullHeightGap = t.height.split("-")[1], t.height = M.height() -
			e.fullHeightGap)
		...
		if (a.startTime = (new Date).getTime(), n.url) {
			...
			c[o.pageName] = e, c[o.limitName] = n.limit, t.ajax({
				...
				dataType: "json",
				success: function(t) {
					return t[r.statusName] != r.statusCode ? (a.renderForm(), a.layMain.html('<div class="' + f + '">' + (t[r.msgName] ||
						"返回的数据状态异常") + "</div>")) : (a.renderData(t, e, t[r.countName]), d(), n.time = (new Date).getTime() - a.startTime +
						" ms", i && l.close(i), void("function" == typeof n.done && n.done(t, e, t[r.countName])))
				},
				error: function(e, t) {
			...
			var s = {},
				u = e * n.limit - n.limit;
			s[r.dataName] = n.data.concat().splice(u, n.limit), s[r.countName] = n.data.length, a.renderData(s, e, n.data.length),
				d(), "function" == typeof n.done && n.done(s, e, s[r.countName])
		}
							...
							if (void 0 !== h && null !== h || (h = ""), !(n.colspan > 1)) {
								var y = ['<td data-field="' + r + '" ' + function() {
									...
									return n.edit && e.push('data-edit="' + n.edit + '"'), n.align && e.push('align="' + n.align + '"'),
										n.templet && e.push('data-content="' + h + '"'), n.toolbar && e.push('data-off="true"'), n.event &&
									...
									return "checkbox" === n.type ? '<input type="checkbox" name="layTableCheckbox" lay-skin="primary" ' +
										...
										}() + ">" : "numbers" === n.type ? f : n.toolbar ? i(t(n.toolbar).html() || "").render(e) : n.templet ?
										i(t(n.templet).html() || String(h)).render(e) : h
								}(), "</div></td>"].join("");
								l.push(y), n.fixed && "right" !== n.fixed && o.push(y), "right" === n.fixed && u.push(y)
							}
						}), h.push('<tr data-index="' + e + '">' + l.join("") + "</tr>"), y.push('<tr data-index="' + e + '">' + o
							.join("") + "</tr>"), p.push('<tr data-index="' + e + '">' + u.join("") + "</tr>"))
					}), c.layBody.scrollTop(0), c.layMain.find("." + f).remove(), c.layMain.find("tbody").html(h.join("")), c.layFixLeft
					.find("tbody").html(y.join("")), c.layFixRight.find("tbody").html(p.join("")), c.renderForm(), c.syncCheckAll(),
					c.haveInit ? c.scrollPatch() : setTimeout(function() {
						c.scrollPatch()
					}, 50), c.haveInit = !0, void l.close(c.tipsIndex))
			};
		return c.key = s.id || s.index, d.cache[c.key] = u, r ? m() : 0 === u.length ? (c.renderForm(), c.layFixed.remove(),
			c.layMain.find("tbody").html(""), c.layMain.find("." + f).remove(), c.layMain.append('<div class="' + f +
				'">无数据</div>')) : (m(), void(s.page && (s.page = t.extend({
		...
		if (t.loading && t.url) return l.msg("数据请求中", {
			icon: 16,
			offset: [e.elem.offset().top + e.elem.height() / 2 - 35 - M.scrollTop() + "px", e.elem.offset().left + e.elem.width() /
				2 - 90 - M.scrollLeft() + "px"
			],
			anim: -1,
			fixed: !1
		})
		...
		var e, t = this,
			i = t.config,
			a = i.height;
		t.fullHeightGap && (a = M.height() - t.fullHeightGap, a < 135 && (a = 135), t.elem.css("height", a)), e =
	...
	var t = layui.$,
		i = {
			fixbar: function(e) {
				...
				var c = [e.bar1, e.bar2, "&#xe604;"],
					g = t(['<ul class="' + a + '">', e.bar1 ? '<li class="layui-icon" lay-type="bar1" style="' + e.bgcolor + '">' +
			...
			timeAgo: function(e, t) {
				...
				return a > 6912e5 ? (a = new Date(e), o[0][0] = i.digit(a.getFullYear(), 4), o[0][1] = i.digit(a.getMonth() + 1),
						o[0][2] = i.digit(a.getDate()), t || (o[1][0] = i.digit(a.getHours()), o[1][1] = i.digit(a.getMinutes()), o[1]
							[2] = i.digit(a.getSeconds())), o[0].join("-") + " " + o[1].join(":")) : a >= 864e5 ? (a / 1e3 / 60 / 60 / 24 |
